...
namespace TMDT.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public ExternalLoginModel(
            ...
            ILogger<ExternalLoginModel> logger, RoleManager<IdentityRole> roleManager,
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        try
                        {
                            ...
                            //$"Please confirm your account by <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>clicking here</a>.");await _emailSender.SendEmailAsync(Input.Email, "Xác nhận email của bạn",
                        }
                        catch (Exception ex)
                        {
